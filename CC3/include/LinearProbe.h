...
protected:
	...
	public:
		HashTable() : array(nextPrime(0)), numHash(0) {}

		// Constructor
		HashTable(const unsigned int size) : array( nextPrime(size) ), numHash(0) { }

		// Insert into the hash
		virtual void insert( const std::pair<Key, Value>& insertPair ){
